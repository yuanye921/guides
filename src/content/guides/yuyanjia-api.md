...
**[build] 反代 + [ver] Vertex 正向：摇摆渠道 (⭐⭐⭐)**

评价：`[build]` 是反代出来的渠道，`[ver]` 是 Vertex 正向，路线不一样；之所以放在一起讲，是因为两边的加甲都相对薄，状态也都比较会“仰卧起坐”。

特点：不一定什么时候死，也不一定什么时候活。能用时发挥不错，抽风时就换回主力，别把整段剧情全压在它们身上。
